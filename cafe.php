...
<body>
    <section id="blog" class="py-4">
        ...
        <div class="title-wrap">
                <h3 class="lg-title">Cafe</h3>
            </div>
            <div class="blog-row">
                <?php
                // Pagination konfigurasi
                $results_per_page = 6; // Jumlah hasil per halaman
                $sql = "SELECT COUNT(*) AS total FROM posts WHERE kategori1 LIKE '%cafe%' OR kategori2 LIKE '%cafe%' OR kategori3 LIKE '%cafe%'";
                ...
                $sql = "SELECT * FROM posts where kategori1 LIKE '%cafe%' OR kategori2 LIKE '%cafe%' OR kategori3 LIKE '%cafe%' LIMIT $start_index, $results_per_page";
                $result = $con->query($sql);
    ...
    <div class="pagination">
        ...
        for ($page = 1; $page <= $total_pages; $page++) {
            echo '<a href="cafe.php?page=' . $page . '">' . $page . '</a> ';
        }
        ?>
    </div>
