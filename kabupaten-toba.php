...
<body>
    <section id="blog" class="py-4">
        ...
        <div class="title-wrap">
                <h3 class="lg-title">Kabupaten Toba</h3>
            </div>
            <div class="blog-row">
                <?php
                // Pagination konfigurasi
                $results_per_page = 6; // Jumlah hasil per halaman
                $sql = "SELECT COUNT(*) AS total FROM posts where kabupaten LIKE '%TOBA%'";
                ...
                $sql = "SELECT * FROM posts where kabupaten LIKE '%TOBA%' LIMIT $start_index, $results_per_page";
                $result = $con->query($sql);
